...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Installing pgAgent &#8212; pgAdmin 4 2.1 documentation</title>
...
<span id="pgagent-install"></span><h1><cite>Installing pgAgent</cite><a class="headerlink" href="#installing-pgagent" title="Permalink to this headline">¶</a></h1>
...
<p>You can then start the service at the command line using <em>net start pgAgent</em>, or from the <em>Services</em> control panel applet. Any logging output or errors will be reported in the Application event log. The DEBUG mode may be used to run pgAgent from a command prompt. When run this way, log messages will output to the command window.</p>
  ...
  <ul>
<li><a class="reference internal" href="#"><cite>Installing pgAgent</cite></a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#"><cite>Installing pgAgent</cite></a><ul>
