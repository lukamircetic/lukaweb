...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Server Deployment &#8212; pgAdmin 4 2.1 documentation</title>
...
<li><p class="first">Edit <code class="docutils literal"><span class="pre">config_local.py</span></code> and add the following settings. In most cases, the default
...
<p>Now open the file <code class="docutils literal"><span class="pre">C:\Program</span> <span class="pre">Files\pgAdmin4\web\pgAdmin4.wsgi</span></code> with your favorite editor and add the code
below which will activate Python virtual environment when Apache server runs.</p>
<div class="highlight-python"><div class="highlight"><pre><span></span><span class="n">activate_this</span> <span class="o">=</span> <span class="s1">&#39;C:\Program Files\pgAdmin4</span><span class="se">\v</span><span class="s1">env\Scripts</span><span class="se">\a</span><span class="s1">ctivate_this.py&#39;</span>
...
<p><strong>Note:</strong> The changes made in <code class="docutils literal"><span class="pre">pgAdmin4.wsgi</span></code> file will revert when pgAdmin4 is either upgraded or downgraded.</p>
</div>
